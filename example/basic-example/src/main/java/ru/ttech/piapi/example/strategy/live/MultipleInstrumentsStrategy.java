...
public class MultipleInstrumentsStrategy {
  ...
  public static void main(String[] args) {
    ...
    var strategy = liveStrategyFactory.newMultipleInstrumentsCandleStrategy(
      MultipleInstrumentsCandleStrategyConfiguration.builder()
        .setInstruments(List.of(ttechShare, sberShare, sberShareTwo))
